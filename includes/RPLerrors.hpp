...
# define ERR_NOSUCHCHANNEL(client, servername)	(":ircserv.42.fr 403 " + client + " " + servername + " :No such channel")					//403
...
# define ERR_NEEDMOREPARAMS(client, command)	(":ircserv.42.fr 461 " + client + " " + command + " :Not enough parameters")				//461
